var jsPsychHtmlAudioResponseWithSketchpad = (function (jspsych) {
  'use strict';

  const info = {
      name: "html-audio-response-with-sketchpad",
      parameters: {
  ...
  /**
   * html-audio-response-multiple
   * jsPsych plugin for displaying a stimulus and recording multiple audio responses through a microphone
   * @author Josh de Leeuw
   * @author Alexis Hu
   * @see ToDo {@link https://www.jspsych.org/plugins/jspsych-html-audio-response/ html-audio-response plugin documentation on jspsych.org}
   */
  class HtmlAudioResponseWithSketchpadPlugin {
      constructor(jsPsych) {
  ...
  HtmlAudioResponseWithSketchpadPlugin.info = info;

  return HtmlAudioResponseWithSketchpadPlugin;
