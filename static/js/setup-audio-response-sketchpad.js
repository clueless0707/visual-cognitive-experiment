...
$(window).on('load', function() {
  return saveData()
  .then(function() {
    return delay(LOCAL ? 280 : 2800, function() {
      $('#welcome').hide();
      if (LOCAL) {
...
async function initializeExperiment() {
  ...
  var instructions_block = {
    ...
    stimulus: markdown(`
      # Welcome to the Visual Problem Solving Experiment
  ...
  // Create a loop of recording   
  var recording_loop = {
    timeline: [start_recording, perform_recording],
